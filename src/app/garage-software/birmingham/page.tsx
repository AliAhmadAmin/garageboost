...
export const metadata: Metadata = {
  title: "MOT Management Software For Birmingham Garages | Garage Boost",
  description:
    "Best garage and MOT reminder software for Birmingham garages. Increase revenue by 40% with automated reminders, DVSA integration, and smart advisory tracking. Serving the West Midlands.",
  keywords: [
    "MOT software Birmingham",
    "garage software Birmingham",
    "garage management Birmingham",
    "MOT reminders Birmingham",
    "garage CRM Birmingham",
    "automotive software Birmingham",
    "MOT advisory software Birmingham",
    "garage software West Midlands",
    "vehicle management Birmingham",
  ],
  metadataBase: new URL("https://garageboost.co.uk"),
  openGraph: {
    title: "MOT Management Software For Birmingham Garages | Garage Boost",
    description:
      "Increase garage revenue by 40% with Garage Boost MOT reminder software. Trusted by Birmingham and UK garages.",
    url: "https://garageboost.co.uk/garage-software/birmingham",
    type: "website",
  },
  alternates: {
    canonical: "https://garageboost.co.uk/garage-software/birmingham",
  },
};
      ...
      <div className="bg-white">
        ...
        <div className="bg-linear-to-br from-blue-600 to-indigo-700 text-white py-20">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <p className="text-blue-100 font-semibold">Serving Birmingham & The West Midlands</p>
            </div>
            <h1 className="text-5xl font-black mb-6">
              MOT & Garage Management Software for Birmingham Garages
            </h1>
            <p className="text-xl text-blue-100 leading-relaxed mb-8">
              Increase your garage revenue by 40% with automated MOT reminders, DVSA integration, and smart advisory tracking. Trusted by garages across Birmingham and the West Midlands.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-20">
          <h2 className="text-4xl font-black text-slate-900 mb-12 text-center">
            Purpose-Built for Birmingham Garages
          </h2>
        ...
        <div className="bg-slate-900 text-white py-20">
          <div className="max-w-5xl mx-auto px-6">
            <h2 className="text-4xl font-black mb-12 text-center">Success Stories from Birmingham Garages</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  name: "Quick Fix Garage, Birmingham",
                  revenue: "£2,800/month",
                  quote: "Setup was incredibly easy. Within a week we saw a massive improvement in customer retention and bookings.",
                  initial: "50 vehicles",
                },
                {
                  name: "Premier Motors, Solihull",
                  revenue: "+£3,500/month",
                  quote: "Best investment we've made. The automated reminders save us 10 hours a week and capture work we'd miss.",
                  initial: "120 vehicles",
                },
                {
                  name: "City Automotive, Wolverhampton",
                  revenue: "£2,200/month",
                  quote: "The CRM features alone are worth it. We know exactly which customers are due and follow up consistently.",
                  initial: "80 vehicles",
                },
              ].map((story, idx) => (
        ...
        <div className="max-w-5xl mx-auto px-6 py-20">
          <div className="bg-blue-50 rounded-2xl p-12 text-center">
            <h2 className="text-4xl font-black text-slate-900 mb-4">Ready to Grow Your Birmingham Garage?</h2>
            <p className="text-slate-600 text-lg mb-8">
              Join garages across the West Midlands increasing their revenue. Start your free 14-day trial today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/signup"
