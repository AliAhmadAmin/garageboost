...
export const metadata: Metadata = {
  title: "MOT Management Software For Bristol Garages | Garage Boost",
  description:
    "Best garage and MOT reminder software for Bristol garages. Increase revenue by 40% with automated reminders, DVSA integration, and smart advisory tracking. Serving the South West.",
  keywords: [
    "MOT software Bristol",
    "garage software Bristol",
    "garage management Bristol",
    "MOT reminders Bristol",
    "garage CRM Bristol",
    "automotive software Bristol",
    "MOT advisory software Bristol",
    "garage software South West",
    "vehicle management Bristol",
  ],
  metadataBase: new URL("https://garageboost.co.uk"),
  openGraph: {
    title: "MOT Management Software For Bristol Garages | Garage Boost",
    description:
      "Increase garage revenue by 40% with Garage Boost MOT reminder software. Trusted by Bristol and UK garages.",
    url: "https://garageboost.co.uk/garage-software/bristol",
    type: "website",
  },
  alternates: {
    canonical: "https://garageboost.co.uk/garage-software/bristol",
  },
};
      ...
      <div className="bg-white">
        ...
        <div className="bg-linear-to-br from-blue-600 to-indigo-700 text-white py-20">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <p className="text-blue-100 font-semibold">Serving Bristol & The South West</p>
            </div>
            <h1 className="text-5xl font-black mb-6">
              MOT & Garage Management Software for Bristol Garages
            </h1>
            <p className="text-xl text-blue-100 leading-relaxed mb-8">
              Increase your garage revenue by 40% with automated MOT reminders, DVSA integration, and smart advisory tracking. Trusted by garages across Bristol and the South West.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-20">
          <h2 className="text-4xl font-black text-slate-900 mb-12 text-center">
            Purpose-Built for Bristol Garages
          </h2>
        ...
        <div className="bg-slate-900 text-white py-20">
          <div className="max-w-5xl mx-auto px-6">
            <h2 className="text-4xl font-black mb-12 text-center">Success Stories from Bristol Garages</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  name: "Elite Automotive, Bristol",
                  revenue: "£5,100/month",
                  quote: "Garage Boost increased our monthly revenue significantly. The automated reminders alone pay for themselves multiple times over.",
                  initial: "200+ vehicles",
                },
                {
                  name: "Professional Motors, Bath",
                  revenue: "+£2,900/month",
                  quote: "Our team saves 12+ hours per week on manual follow-ups. We're now booking 60% more MOTs thanks to these reminders.",
                  initial: "150 vehicles",
                },
                {
                  name: "Family Garage, Yate",
                  revenue: "£2,400/month",
                  quote: "Simple to use, brilliant features, and the customer support is fantastic. Highly recommend to any Bristol garage.",
                  initial: "90 vehicles",
                },
              ].map((story, idx) => (
        ...
        <div className="max-w-5xl mx-auto px-6 py-20">
          <div className="bg-blue-50 rounded-2xl p-12 text-center">
            <h2 className="text-4xl font-black text-slate-900 mb-4">Ready to Grow Your Bristol Garage?</h2>
            <p className="text-slate-600 text-lg mb-8">
              Join garages across the South West increasing their revenue. Start your free 14-day trial today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/signup"
