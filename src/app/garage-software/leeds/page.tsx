...
export const metadata: Metadata = {
  title: "MOT Management Software For Leeds Garages | Garage Boost",
  description:
    "Best garage and MOT reminder software for Leeds garages. Increase revenue by 40% with automated reminders, DVSA integration, and smart advisory tracking. Serving Yorkshire and the North.",
  keywords: [
    "MOT software Leeds",
    "garage software Leeds",
    "garage management Leeds",
    "MOT reminders Leeds",
    "garage CRM Leeds",
    "automotive software Leeds",
    "MOT advisory software Leeds",
    "garage software Yorkshire",
    "vehicle management Leeds",
  ],
  metadataBase: new URL("https://garageboost.co.uk"),
  openGraph: {
    title: "MOT Management Software For Leeds Garages | Garage Boost",
    description:
      "Increase garage revenue by 40% with Garage Boost MOT reminder software. Trusted by Leeds and UK garages.",
    url: "https://garageboost.co.uk/garage-software/leeds",
    type: "website",
  },
  alternates: {
    canonical: "https://garageboost.co.uk/garage-software/leeds",
  },
};
      ...
      <div className="bg-white">
        ...
        <div className="bg-linear-to-br from-blue-600 to-indigo-700 text-white py-20">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <p className="text-blue-100 font-semibold">Serving Leeds & Yorkshire</p>
            </div>
            <h1 className="text-5xl font-black mb-6">
              MOT & Garage Management Software for Leeds Garages
            </h1>
            <p className="text-xl text-blue-100 leading-relaxed mb-8">
              Increase your garage revenue by 40% with automated MOT reminders, DVSA integration, and smart advisory tracking. Trusted by garages across Leeds and Yorkshire.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-20">
          <h2 className="text-4xl font-black text-slate-900 mb-12 text-center">
            Purpose-Built for Leeds Garages
          </h2>
        ...
        <div className="bg-slate-900 text-white py-20">
          <div className="max-w-5xl mx-auto px-6">
            <h2 className="text-4xl font-black mb-12 text-center">Success Stories from Leeds Garages</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  name: "Northern Motors, Leeds",
                  revenue: "£4,100/month",
                  quote: "Invested in Garage Boost and saw results immediately. Our customer base grew 35% in the first 6 weeks.",
                  initial: "180 vehicles",
                },
                {
                  name: "Yorkshire Automotive, Sheffield",
                  revenue: "+£2,700/month",
                  quote: "The software is intuitive and the support team is responsive. Worth every penny for what it saves us.",
                  initial: "110 vehicles",
                },
                {
                  name: "Bradford Garage Services",
                  revenue: "£2,000/month",
                  quote: "Finally, a tool that works with us, not against us. Our staff are happier and our customers get better service.",
                  initial: "75 vehicles",
                },
              ].map((story, idx) => (
        ...
        <div className="max-w-5xl mx-auto px-6 py-20">
          <div className="bg-blue-50 rounded-2xl p-12 text-center">
            <h2 className="text-4xl font-black text-slate-900 mb-4">Ready to Grow Your Leeds Garage?</h2>
            <p className="text-slate-600 text-lg mb-8">
              Join garages across Yorkshire increasing their revenue. Start your free 14-day trial today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/signup"
