...
"[project]/src/app/api/stripe/checkout/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        const userSession = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionFromRequest"])(req);
        if (!userSession) {
        ...
        const priceId = planKey === "pro" || planKey === "professional" ? process.env.STRIPE_PRO_PRICE_ID : planKey === "business" ? process.env.STRIPE_BUSINESS_PRICE_ID : process.env.STRIPE_BASIC_PRICE_ID;
        if (!priceId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isAdminRole"])(userSession.role)) {
        ...
        const checkoutSession = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripe"].checkout.sessions.create({
            mode: 'subscription',
            ...
            success_url: `${("TURBOPACK compile-time value", "http://localhost:3000")}/garage?success=true&session_id={CHECKOUT_SESSION_ID}`,
            cancel_url: `${("TURBOPACK compile-time value", "http://localhost:3000")}/garage?canceled=true`,
            metadata: {
                garageId,
                plan
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__991b10dc._.js.map