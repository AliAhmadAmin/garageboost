...
"[project]/src/app/api/garages/[id]/expenses/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const expenses = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].expense.findMany({
            where: {
                garageId: id,
                ...category && {
                    category
...
async function POST(request, { params }) {
    try {
        ...
        const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$guards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireGarageAdminAccess"])(request, id);
        if ("response" in guard) return guard.response;
        const { title, category, amountPence, taxPence, vendor, paymentMethod, status, incurredAt, notes } = body;
        ...
        const expense = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].expense.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3983ec4._.js.map