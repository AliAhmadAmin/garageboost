...
"[project]/src/app/api/garages/featured/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const featured = garages.map((garage)=>{
            ...
            const averageRating = reviewCount > 0 ? (approvedReviews.reduce((sum, r)=>sum + r.rating, 0) / reviewCount).toFixed(1) : null;
            return {
                id: garage.id,
                name: garage.name,
                slug: garage.slug,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(featured, {
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e992c24._.js.map