...
"[project]/src/app/api/garages/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const buildUniqueSlug = async (base, excludeId)=>{
    const normalized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slug$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slugify"])(base);
    let candidate = normalized;
    let counter = 2;
    while(true){
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].garage.findFirst({
            where: {
                slug: candidate,
                ...excludeId ? {
                    NOT: {
...
async function GET(req, { params }) {
    try {
        ...
        const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$guards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireGarageAccess"])(req, id);
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isAdminRole"])(guard.session.role)) {
            const [summary, payments] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].garagePayment.aggregate({
                    where: {
                        garageId: id
                    },
                    _sum: {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].garagePayment.findMany({
                    where: {
                        garageId: id
                    },
                    orderBy: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(garage);
    } catch (error) {
...
async function PUT(req, { params }) {
    try {
        ...
        if (typeof body.slug === "string") {
            const normalized = body.slug.trim() ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slug$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slugify"])(body.slug) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slug$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slugify"])(body.name || "garage");
            nextSlug = await buildUniqueSlug(normalized, id);
        }
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].garage.update({
            where: {
                id
            },
            data: {
                ...
                revenuePence: Number.isFinite(body.revenuePence) ? Number(body.revenuePence) : undefined,
...
async function DELETE(req, { params }) {
    try {
        ...
        for (const vehicle of vehicles){
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].reminder.deleteMany({
                where: {
                    vehicleId: vehicle.id
                }
            });
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vehicle.deleteMany({
            where: {
                garageId: id
            }
        });
        // Then delete the garage
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].garage.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__825010dc._.js.map