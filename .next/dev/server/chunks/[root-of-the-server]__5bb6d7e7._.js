...
async function GET(req, { params }) {
    ...
    if (invoice.totalPence === 0 && invoice.job?.items?.length > 0) {
        ...
        let laborTotal = 0;
        let partsTotal = 0;
        invoice.job.items.forEach((item)=>{
        ...
        console.log("[Invoice GET] Recalculated totals:", {
            subtotalPence,
            vatPence,
            totalPence
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedInvoice);
    }
...
async function PUT(req, { params }) {
    ...
    const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$guards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireInvoiceAccess"])(req, id);
    if ("response" in guard) return guard.response;
    const invoice = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].invoice.update({
        where: {
            id
        },
        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5bb6d7e7._.js.map