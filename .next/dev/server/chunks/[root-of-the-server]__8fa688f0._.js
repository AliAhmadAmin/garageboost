...
"[project]/src/lib/app-url.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getAppBaseUrl(req) {
    ...
    if (originHeader && (!isLocalhostUrl(originHeader) || ("TURBOPACK compile-time value", "development") !== "production")) {
        return originHeader;
    }
    ...
    if (forwardedHost) {
        ...
        if (!isLocalhostUrl(forwardedOrigin) || ("TURBOPACK compile-time value", "development") !== "production") {
            return forwardedOrigin;
        }
    }
    const envUrl = normalizeBaseUrl(("TURBOPACK compile-time value", "https://garage.bizzboost.uk")) || normalizeBaseUrl(("TURBOPACK compile-time value", "https://garage.bizzboost.uk"));
    if (envUrl && (!isLocalhostUrl(envUrl) || ("TURBOPACK compile-time value", "development") !== "production")) {
        return envUrl;
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$app$2d$url$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/app-url.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    try {
        ...
        const appBaseUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$app$2d$url$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAppBaseUrl"])(req);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            details: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : error
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8fa688f0._.js.map