...
async function GET(request) {
    ...
    const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$guards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireGarageAdminAccess"])(request, garageId);
...
async function POST(request) {
    try {
        ...
        if (!garageId || !name || !message) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "garageId, name, and message are required"
            }, {
                status: 400
            });
        }
        ...
        if (channel !== "EMAIL") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "SMS campaigns are not enabled yet"
            }, {
                status: 400
            });
        }
        const subjectValue = subject || name;
        const campaign = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].campaign.create({
            data: {
                garageId,
                name,
                ...
                status: scheduledFor && scheduledFor > new Date() ? "SCHEDULED" : "SENDING"
            }
        });
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$campaigns$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendCampaign"])({
            campaignId: campaign.id,
            originHeader: request.headers.get("origin")
        });
        const refreshed = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].campaign.findUnique({
            where: {
                id: campaign.id
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(refreshed, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e796bacc._.js.map