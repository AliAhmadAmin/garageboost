...
async function GET(request) {
    ...
    if (garageId) {
        ...
        staffContext = guard.staff ? {
            id: guard.staff.id,
            accessRole: guard.staff.accessRole
        } : undefined;
    } else if (vehicleId) {
    ...
    if (staffContext) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2d$control$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAssignmentScope"])(staffContext.accessRole) === "ASSIGNED") {
            where.assignedToId = staffContext.id;
        }
    }
    const jobs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].job.findMany({
        where,
        include: {
            vehicle: true,
            items: true,
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(jobsWithTotals);
}
async function POST(request) {
    try {
        ...
        const count = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].job.count({
            where: {
                jobNumber: {
                    startsWith: `JOB-${year}-`
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d227937b._.js.map