...
"[project]/src/app/api/vehicles/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request) {
    ...
    const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$guards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireVehicleAccess"])(request, id);
    if ("response" in guard) return guard.response;
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vehicle.delete({
        where: {
            id
        }
    });
...
async function PUT(request) {
    ...
    const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$guards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireVehicleAccess"])(request, id);
    if ("response" in guard) return guard.response;
    const vehicle = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vehicle.update({
        where: {
            id
        },
        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c2e478b._.js.map