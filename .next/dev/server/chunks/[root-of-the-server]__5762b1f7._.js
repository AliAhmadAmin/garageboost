...
function applyTemplate(template, recipient) {
    return template.replace(/{name}/g, recipient.name || "Customer").replace(/{vrm}/g, recipient.vrm || "").replace(/{make}/g, recipient.make || "").replace(/{model}/g, recipient.model || "").replace(/{motExpiry}/g, recipient.motExpiry ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$uk$2d$date$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatUKDate"])(recipient.motExpiry) : "");
}
async function POST(request) {
    try {
        ...
        const selectedCustomers = Array.isArray(body.selectedCustomers) ? body.selectedCustomers.map((value)=>String(value).trim()).filter(Boolean) : [];
        ...
        if (channel !== "email") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Only email channel is supported"
            }, {
                status: 400
            });
        }
        ...
        if (selectedCustomers.length > 0) {
            const [customersFromDb, vehiclesFromDb] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.findMany({
                    where: {
                        garageId,
                        name: {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vehicle.findMany({
                    where: {
                        garageId,
                        ownerName: {
                            in: selectedCustomers
        ...
        const now = new Date();
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].emailQueueJob.createMany({
            data: recipients.map((recipient)=>({
                    ...
                    message: applyTemplate(message, recipient),
                    status: "PENDING",
                    attempts: 0,
                    maxAttempts: 5,
                    scheduledFor: now
        ...
        void (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2d$queue$2d$processor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["processEmailQueue"])(15).catch((error)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5762b1f7._.js.map