...
"[project]/src/app/api/garages/[id]/inventory/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].inventoryItem.findMany({
            where: {
                garageId: id,
                ...activeOnly && {
                    isActive: true
        ...
        const filteredItems = lowStock ? items.filter((item)=>item.quantityOnHand <= item.reorderLevel) : items;
...
async function POST(request, { params }) {
    try {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].inventoryItem.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b0909777._.js.map