...
"[project]/src/app/api/garages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (includeAll) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isAdminRole"])(sessionResult.session.role)) {
    ...
    for (const garage of garages){
        if (!garage.slug && garage.name) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].garage.update({
                where: {
                    id: garage.id
                },
                data: {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(garages, {
        headers: {
...
async function POST(request) {
    ...
    const requestedSlug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slug$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slugify"])(body.slug || body.name || "garage");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fdb6edc6._.js.map