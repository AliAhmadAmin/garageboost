...
"[project]/src/app/api/jobs/[id]/items/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    ...
    const items = await Promise.all(body.items.map(async (item)=>{
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].jobItem.create({
            data: {
                jobId: id,
                type: item.type,
                name: item.name,
    ...
    const allItems = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].jobItem.findMany({
        where: {
            jobId: id
        }
    });
...
async function DELETE(req, { params }) {
    ...
    const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$guards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireJobAccess"])(req, jobId);
    if ("response" in guard) return guard.response;
    if (!itemId) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].jobItem.delete({
        where: {
            id: itemId
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a42cac1._.js.map