...
async function GET(request) {
    ...
    const totalRevenuePotential = vehicles.reduce((acc, v)=>{
        const advisoryTotal = v.advisories.reduce((sum, a)=>sum + a.estPricePence, 0);
        return acc + advisoryTotal + 5485; // MOT price
    }, 0);
    const remindersSent = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].reminder.count({
        where: {
            vehicle: {
                garageId
            },
    ...
    const remindersPending = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].reminder.count({
        where: {
            vehicle: {
                garageId
            },
    ...
    const totalJobs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].job.count({
        where: {
            garageId
        }
    });
    // Count converted jobs (completed, invoiced, or paid status)
    const convertedJobs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].job.count({
        where: {
            garageId,
            status: {
                in: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2f1f96b._.js.map