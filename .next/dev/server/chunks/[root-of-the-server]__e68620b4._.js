...
"[project]/src/app/api/garages/[id]/customers/[customerId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        console.log("[CRM API] Updating customer:", {
            customerId,
            name,
            email
        });
        ...
        const existingCustomer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.findFirst({
            where: {
                id: customerId,
                garageId
            },
        ...
        const [, , updated] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.update({
                where: {
                    id: customerId
                },
                data: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vehicle.updateMany({
                where: {
                    customerId
                },
...
async function DELETE(request, { params }) {
    try {
        const { id: garageId, customerId } = await params;
        console.log("[CRM API] Deleting customer:", {
            customerId
        });
        const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$guards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireGarageAccess"])(request, garageId);
        if ("response" in guard) return guard.response;
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].advisory.deleteMany({
                where: {
                    vehicleId: {
                        in: vehicleIds
                    }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].reminder.deleteMany({
                where: {
                    vehicleId: {
                        in: vehicleIds
                    }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vehicle.deleteMany({
                where: {
                    id: {
                        in: vehicleIds
                    }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.delete({
                where: {
                    id: customerId
                }
            })
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            customerId,
            deletedVehicleCount: vehicleIds.length
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e68620b4._.js.map