...
async function POST(request) {
    try {
        ...
        const emailLimitKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRateLimitKey"])(email, "login");
        const emailLimit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(emailLimitKey, parseInt(process.env.RATE_LIMIT_LOGIN_ATTEMPTS || "5"), parseInt(process.env.RATE_LIMIT_LOGIN_WINDOW_MINUTES || "15"));
        ...
        const isValidPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, user.passwordHash);
        if (!isValidPassword) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Invalid credentials"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__da4386ca._.js.map