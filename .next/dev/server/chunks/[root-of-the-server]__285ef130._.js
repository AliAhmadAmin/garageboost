...
"[project]/src/app/api/garages/[id]/reviews/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$guards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireGarageAdminAccess"])(request, id);
        if ("response" in guard) return guard.response;
        const reviews = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.findMany({
            where: {
                garageId: id,
                ...status && {
                    status
...
async function POST(request, { params }) {
    try {
        ...
        const existingReview = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.findFirst({
            where: {
                garageId: id,
                customerEmail
            }
        ...
        const review = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.create({
            data: {
                garageId: id,
                rating,
                title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__285ef130._.js.map