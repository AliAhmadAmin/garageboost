...
;
;
function TrialBanner({ trialEndsAt, currentPlan, status, onViewPlans }) {
    ...
    const trial = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$plans$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTrialStatus"])(trialEndsAt);
    const plan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$plans$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPlanLimits"])(currentPlan);
    // Trial expired
    if (trial.expired) {
...
;
;
function PlanUpgradeModal({ isOpen, onClose, currentPlan = "TRIAL", currentStatus, garageId, isRefreshing = false }) {
    _s();
    ...
    const normalizedCurrentPlan = isTrialStatus ? null : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$plans$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizePlanId"])(currentPlan);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PlanUpgradeModal.useEffect": ()=>{
            if (!isOpen) return;
            setSelectedPlan((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$plans$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizePlanId"])(currentPlan) ?? "starter");
            setError(null);
...
const Sidebar = ()=>{
    ...
    const [bookingRequestsEnabled, setBookingRequestsEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [showNewBookingAlert, setShowNewBookingAlert] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [newBookingCount, setNewBookingCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [showPushPrompt, setShowPushPrompt] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const alertTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const previousPendingBookingsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const syncPushSubscription = async (resolvedGarageId)=>{
        if (!("serviceWorker" in navigator) || !("PushManager" in window)) return;
        const vapidPublicKey = ("TURBOPACK compile-time value", "BNbC0pJ-n_moXvMbSQ-4Vnv5Z-DdOKdDphl7dA9kAsGAEKA6-FmrlEUzW1Qb7DXPfStc1ANWBHVBVE5A--L9EJE");
    ...
    const triggerNewBookingAlert = (increase, totalPending)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Sidebar.useEffect": ()=>{
            ...
            const loadNotificationPreferences = {
                "Sidebar.useEffect.loadNotificationPreferences": async ()=>{
                    try {
            ...
            }["Sidebar.useEffect.loadNotificationPreferences"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Sidebar.useEffect": ()=>{
            ...
            if (Notification.permission === "granted") {
                void syncPushSubscription(garageId).catch({
                    "Sidebar.useEffect": ()=>undefined
                }["Sidebar.useEffect"]);
            } else {
                setShowPushPrompt(false);
            }
            ...
            const loadPendingCounts = {
                "Sidebar.useEffect.loadPendingCounts": async ()=>{
                    try {
                        ...
                        setGarageId({
                            "Sidebar.useEffect.loadPendingCounts": (previous)=>previous === resolvedGarageId ? previous : resolvedGarageId
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            showNewBookingAlert && bookingRequestsEnabled && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed top-4 right-4 left-4 lg:left-auto lg:top-6 lg:right-6 z-120 max-w-sm ml-auto",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-emerald-600 text-white rounded-xl shadow-2xl p-4 border border-emerald-500",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    newBookingCount,
                                                    " new ",
                                                    newBookingCount === 1 ? "booking" : "bookings",
                                                    " pending."
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/src/app/garage/layout.tsx",
            ...
            showPushPrompt && bookingRequestsEnabled && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed bottom-20 right-4 left-4 lg:left-auto lg:bottom-6 lg:right-6 z-120 max-w-sm ml-auto",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-slate-900 text-white rounded-xl shadow-2xl p-4 border border-slate-700",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "font-bold",
                            children: "Enable booking push alerts?"
                        }, void 0, false, {
                            fileName: "[project]/src/app/garage/layout.tsx",
                            lineNumber: 451,
                            columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Get instant alerts even when the app is in the background."
                        }, void 0, false, {
                            fileName: "[project]/src/app/garage/layout.tsx",
                            lineNumber: 452,
                            columnNumber: 13
...
_s(Sidebar, "c1Pq5P3Ae2+slJD5CXC6tksbZ5Q=", false, function() {
    return [
                    ...
                    ({
                        "GarageLayout.useEffect": async ()=>{
                            try {
                                ...
                                await new Promise({
                                    "GarageLayout.useEffect": (r)=>setTimeout(r, 1000)
                                }["GarageLayout.useEffect"]);
                                const maxAttempts = 6;
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Your trial period has ended. Please add a payment method to continue using Garage Boost."
                        }, void 0, false, {
                            fileName: "[project]/src/app/garage/layout.tsx",
                            lineNumber: 756,
                            columnNumber: 13
...
_s1(GarageLayout, "5yAl/eCNoyh/gTuSluZ/T3Z8TKs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_d698c26e._.js.map